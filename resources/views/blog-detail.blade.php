    ...
    <div class="container py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="row g-5">
            <div class="col-lg-8">
                <!--blog detail start-->
                <div class="mb-5">
                    <img class="img-fluid w-100 rounded mb-5" src="{{ asset('public/assets/img/blog-1.jpg') }}" alt="">
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex mb-4">
                        <img src="{{ asset('public/assets/img/user.jpg') }}" class="img-fluid rounded" style="width: 45px; height: 45px;">
                        <div class="ps-3">
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex rounded overflow-hidden mb-3">
                        <img class="img-fluid" src="{{ asset('public/assets/img/blog-1.jpg') }}" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                        <a href="" class="h5 d-flex align-items-center bg-light px-3 mb-0">Lorem ipsum dolor sit amet adipis elit
                        </a>
                    </div>
                    <div class="d-flex rounded overflow-hidden mb-3">
                        <img class="img-fluid" src="{{ asset('public/assets/img/blog-2.jpg') }}" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                        <a href="" class="h5 d-flex align-items-center bg-light px-3 mb-0">Lorem ipsum dolor sit amet adipis elit
                        </a>
                    </div>
                    <div class="d-flex rounded overflow-hidden mb-3">
                ...
                <!--image start-->
                <div class="mb-5">
                    <img src="{{ asset('public/assets/img/blog-1.jpg') }}" alt="" class="img-fluid rounded">
                </div>
                <!--image end-->
                <!--tags start-->
                <div class="mb-5">
