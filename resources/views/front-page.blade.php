...
<div class="container-fluid p-0 mb-5">
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-indicators">
            ...
            <button type="button" data-bs-target="#header-carousel" data-bs-slide-to="{{ $count }}" class="{{ $count == 0 ? 'active' : '' }}" aria-current="{{ $count == 0 ? 'true' : 'false' }}" aria-label="Slide {{ $count + 1 }}"></button>
            @php $count++; @endphp
            @endforeach
        </div>
        <div class="carousel-inner">
            ...
            <div class="carousel-item @if ($count == 0) active @endif">
                <img class="w-100" src="{{ asset('public/uploads/sliders/' .$slider->image) }}" alt="Image">
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                <div class="p-3" style="max-width: 900px;">
                    <h5 class="text-white text-uppercase animated bounceInDown">{{ $slider->title }}</h5>
                    <h1 class="display-1 text-white mb-md-4 animated zoomIn">{{ $slider->desc }}</h1>
            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.3s" src="{{ asset('public/assets/img/about.jpg') }}" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mb-4">
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="service-item bg-light border-bottom border-5 border-primary rounded">
                        <div class="position-relative p-5">
                            ...
                            <h5 class="text-primary mb-0">{{ $service->title }}</h5>
            ...
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="position-relative rounded-top">
                        <img class="img-fluid rounded-top w-100" src="{{ asset('public/assets/img/team-1.jpg') }}" alt="">
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="position-relative rounded-top">
                        <img class="img-fluid rounded-top w-100" src="{{ asset('public/assets/img/team-2.jpg') }}" alt="">
                        <div class="position-absolute bottom-0 end-0 d-flex flex-column bg-white p-1" style="margin-right: -25px;">
                            <a class="btn btn-outline-secondary btn-square m-1" href="#"><i class="fab fa-twitter fw-normal"></i></a>
                            <a class="btn btn-outline-secondary btn-square m-1" href="#"><i class="fab fa-facebook-f fw-normal"></i></a>
                            <a class="btn btn-outline-secondary btn-square m-1" href="#"><i class="fab fa-linkedin-in fw-normal"></i></a>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="position-relative rounded-top">
                        <img class="img-fluid rounded-top w-100" src="{{ asset('public/assets/img/team-3.jpg') }}" alt="">
                        <div class="position-absolute bottom-0 end-0 d-flex flex-column bg-white p-1" style="margin-right: -25px;">
                            <a class="btn btn-outline-secondary btn-square m-1" href="#"><i class="fab fa-twitter fw-normal"></i></a>
                            <a class="btn btn-outline-secondary btn-square m-1" href="#"><i class="fab fa-facebook-f fw-normal"></i></a>
                            <a class="btn btn-outline-secondary btn-square m-1" href="#"><i class="fab fa-linkedin-in fw-normal"></i></a>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel">
                ...
                <div class="text-center pb-4">
                    <img class="img-fluid mx-auto rounded-circle" src="{{ asset('public/uploads/testimonials/'. $testimonial->image) }}" style="width: 100px; height: 100px;" >
                    <div class="testimonial-text bg-light rounded p-4 mt-n5">
                        <p class="mt-5">{{ $testimonial->desc }}
                        </p>
                        <h4 class="text-truncate">{{ $testimonial->name }}</h4>
        ...
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <div class="blog-item">
                        <div class="position-relative">
                            <img class="img-fluid w-100 rounded-top" src="{{ asset('public/assets/img/blog-1.jpg') }}" alt="">
                            <div class="blog-date">
                ...
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.6s">
                    <div class="blog-item">
                        <div class="position-relative">
                            <img class="img-fluid w-100 rounded-top" src="{{ asset('public/assets/img/blog-2.jpg') }}" alt="">
                            <div class="blog-date">
                                <h5 class="text-white fw-bold mb-0">01</h5>
                                <h6 class="text-light mb-0">January</h6>
                            </div>
