         ...
         <div class="row">
            <div class="col-12">
               ...
               <div class="trash-contact">
                        <a href="{{ url('admin/all-testimonials-trash-list') }}" class="export"><img src="{{ url('public/admin/dist/img/trash.svg') }}"></a>
                    </div>
                  <div class="card-body">
                     <!--start table-->
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td class="project-actions text-left">
                                 ...
                                 <a class="btn btn-danger btn-sm trash_testimonial_record" data-testimonial_id="{{ $testimonial->id }}"><i class="fas fa-trash" aria-hidden="true"></i>Delete</a>
                              </td>
                           </tr>
                           @php $count++; @endphp
                           @endforeach
