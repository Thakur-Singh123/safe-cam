      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="card card-secondary add-new-employee">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.submit.service') }}" method="POST" enctype="multipart/form-data" required>
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="sub_title" name="sub_title" class="form-control" placeholder="Enter Sub Title" required>
                        </div>
                        <div class="form-group">
