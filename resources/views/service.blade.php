        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="text-center pb-4">
                    <img class="img-fluid mx-auto rounded-circle" src="{{ asset('public/assets/img/testimonial-1.jpg') }}" style="width: 100px; height: 100px;" >
                ...
                <div class="text-center">
                    <img class="img-fluid mx-auto rounded-circle" src="{{ asset('public/assets/img/testimonial-2.jpg') }}" style="width: 100px; height: 100px;" >
                    <div class="testimonial-text bg-light rounded p-4 mt-n5">
                        <p class="mt-5">Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam
                        </p>
                        <h4 class="text-truncate">Client Name</h4>
                ...
                <div class="text-center">
                    <img class="img-fluid mx-auto rounded-circle" src="{{ asset('public/assets/img/testimonial-3.jpg') }}" style="width: 100px; height: 100px;" >
                    <div class="testimonial-text bg-light rounded p-4 mt-n5">
                        <p class="mt-5">Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam
                        </p>
                        <h4 class="text-truncate">Client Name</h4>
                ...
                <div class="text-center">
                    <img class="img-fluid mx-auto rounded-circle" src="{{ asset('public/assets/img/testimonial-4.jpg') }}" style="width: 100px; height: 100px;" >
                    <div class="testimonial-text bg-light rounded p-4 mt-n5">
                        <p class="mt-5">Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam
                        </p>
                        <h4 class="text-truncate">Client Name</h4>
